                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{tenant.emailConfiguration?.headers ? tenant.emailConfiguration?.headers?.join(', ') : '-'}</TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </CardContent>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{tenant.emailConfiguration?.allowEmailChangeWhenGated ? 'Yes' : 'No'}</TableCell>
                            </TableRow>
                            <TableRow>
